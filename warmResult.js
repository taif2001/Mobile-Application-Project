...
export default function WarmResult() {
      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>
            Your skin has golden, peachy, or yellow tones beneath the surface.
            Warm shades enhance your natural glow and make your complexion
